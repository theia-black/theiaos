...
public enum TheiaOSTalkCommand: String, Codable, Sendable {
...
public struct TheiaOSTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct TheiaOSTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
