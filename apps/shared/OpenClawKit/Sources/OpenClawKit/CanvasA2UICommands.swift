...
public enum TheiaOSCanvasA2UICommand: String, Codable, Sendable {
...
public struct TheiaOSCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct TheiaOSCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
