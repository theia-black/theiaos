...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.theiaos", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.theiaos", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: TheiaOSProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
