...
public typealias TheiaOSPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias TheiaOSPlatformImage = UIImage
#endif

public struct TheiaOSChatUsageCost: Codable, Hashable, Sendable {
...
public struct TheiaOSChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: TheiaOSChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(TheiaOSChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct TheiaOSChatMessageContent: Codable, Hashable, Sendable {
...
public struct TheiaOSChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [TheiaOSChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: TheiaOSChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [TheiaOSChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: TheiaOSChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(TheiaOSChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([TheiaOSChatMessageContent].self, forKey: .content) {
...
public struct TheiaOSChatHistoryPayload: Codable, Sendable {
...
public struct TheiaOSSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct TheiaOSSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [TheiaOSSessionPreviewItem]
}

public struct TheiaOSSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [TheiaOSSessionPreviewEntry]

    public init(ts: Int, previews: [TheiaOSSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct TheiaOSChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct TheiaOSChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct TheiaOSAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct TheiaOSChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct TheiaOSGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct TheiaOSPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: TheiaOSPlatformImage?
...
public struct TheiaOSChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
