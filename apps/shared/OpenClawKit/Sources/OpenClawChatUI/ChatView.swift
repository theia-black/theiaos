...
@MainActor
public struct TheiaOSChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: TheiaOSChatViewModel
    ...
    public init(
        viewModel: TheiaOSChatViewModel,
    ...
    private var visibleMessages: [TheiaOSChatMessage] {
        let base: [TheiaOSChatMessage]
    ...
    private func mergeToolResults(in messages: [TheiaOSChatMessage]) -> [TheiaOSChatMessage] {
    ...
    private func isToolResultMessage(_ message: TheiaOSChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: TheiaOSChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: TheiaOSChatMessage) -> String {
