...
final class ScreenController {
    ...
    /// Callback invoked when an theiaos:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = TheiaOSKitResources.bundle
...
/// Handles navigation policy to intercept theiaos:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept theiaos:// deep links.
        if url.scheme?.lowercased() == "theiaos" {
