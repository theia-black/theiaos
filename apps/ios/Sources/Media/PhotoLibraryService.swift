...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: TheiaOSPhotosLatestParams) async throws -> TheiaOSPhotosLatestPayload {
        ...
        var results: [TheiaOSPhotoPayload] = []
        ...
        return TheiaOSPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> TheiaOSPhotoPayload
    {
