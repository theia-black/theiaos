...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.theiaos.gateway"
    private static let nodeService = "ai.theiaos.node"
    private static let talkService = "ai.theiaos.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.theiaos.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.theiaos.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("theiaos-gateway.log")
    }
