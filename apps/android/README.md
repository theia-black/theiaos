## TheiaOS Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_theiaos-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm theiaos gateway --port 18789 --verbose
```
