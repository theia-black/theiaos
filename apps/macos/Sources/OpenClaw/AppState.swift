...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = TheiaOSConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = TheiaOSConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = TheiaOSConfigFile.loadDict()
            ...
            TheiaOSConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/theiaos"
        state.remoteCliPath = ""
        return state
    }
}
