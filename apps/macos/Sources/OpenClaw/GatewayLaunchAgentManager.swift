...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.theiaos", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".theiaos/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.theiaosCommand(
            subcommand: "gateway",
