...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.theiaos", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.theiaos", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [TheiaOSChatMessage] = messages.compactMap { item in
