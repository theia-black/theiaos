...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/theia-black/theiaos") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/theia-black/theiaos")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://theiaos.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "TheiaOSBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "TheiaOSBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "TheiaOSGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "TheiaOSGitCommit") as? String) ??
            "unknown"
    }
