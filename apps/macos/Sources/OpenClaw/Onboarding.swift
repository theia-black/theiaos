...
enum UIStrings {
    static let welcomeTitle = "Welcome to TheiaOS"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "theiaos.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: TheiaOSOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: TheiaOSChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g theiaos@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: TheiaOSChatViewModel(
