...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .theiaosSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? TheiaOSPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? TheiaOSPaths.stateDirURL.path
...
extension Notification.Name {
    static let theiaosSelectSettingsTab = Notification.Name("theiaosSelectSettingsTab")
}
