...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.theiaos", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return TheiaOSConfigFile.defaultWorkspaceURL() }
