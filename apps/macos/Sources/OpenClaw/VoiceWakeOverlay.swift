...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.theiaos", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other TheiaOS windows, but below the system’s pop-up menus.
