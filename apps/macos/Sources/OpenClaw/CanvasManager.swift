...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.theiaos", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("TheiaOS/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__theiaos__/a2ui/").absoluteString + "?platform=macos"
    }
