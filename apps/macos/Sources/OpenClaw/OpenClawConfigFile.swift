...
enum TheiaOSConfigFile {
    private static let logger = Logger(subsystem: "ai.theiaos", category: "config")
    ...
    static func stateDirURL() -> URL {
        TheiaOSPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        TheiaOSPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-theiaos-config-file",
            "event": "config.write",
