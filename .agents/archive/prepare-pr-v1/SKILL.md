...
- `fix: <summary> (theiaos#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (theiaos#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "theiaos#$pr_number" || { echo "ERROR: commit subject missing theiaos#$pr_number"; exit 1; }
