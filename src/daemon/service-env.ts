...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.THEIAOS_STATE_DIR;
  const configPath = env.THEIAOS_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    THEIAOS_PROFILE: profile,
    THEIAOS_STATE_DIR: stateDir,
    THEIAOS_CONFIG_PATH: configPath,
    THEIAOS_GATEWAY_PORT: String(port),
    THEIAOS_GATEWAY_TOKEN: token,
    THEIAOS_LAUNCHD_LABEL: resolvedLaunchdLabel,
    THEIAOS_SYSTEMD_UNIT: systemdUnit,
    THEIAOS_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    THEIAOS_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    THEIAOS_STATE_DIR: stateDir,
    THEIAOS_CONFIG_PATH: configPath,
    THEIAOS_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    THEIAOS_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    THEIAOS_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    THEIAOS_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    THEIAOS_LOG_PREFIX: "node",
    THEIAOS_SERVICE_MARKER: NODE_SERVICE_MARKER,
    THEIAOS_SERVICE_KIND: NODE_SERVICE_KIND,
    THEIAOS_SERVICE_VERSION: VERSION,
  };
}
