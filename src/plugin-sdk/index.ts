...
export type { TheiaOSConfig } from "../config/config.js";
/** @deprecated Use TheiaOSConfig instead */
export type { TheiaOSConfig as ClawdbotConfig } from "../config/config.js";
