...
import type { TheiaOSPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: TheiaOSPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: TheiaOSPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
