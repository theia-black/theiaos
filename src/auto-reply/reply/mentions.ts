...
function resolveMentionPatterns(cfg: TheiaOSConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: TheiaOSConfig | undefined, agentId?: string): RegExp[] {
