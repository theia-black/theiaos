...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@theiaos", { botUsername: "theiaos" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@theiaos args", {
        botUsername: "theiaos",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "theiaos" })).toBe(
      "/help@otherbot",
    );
  });
