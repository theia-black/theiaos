...
type PromptDefaultModelResult = { model?: string; config?: TheiaOSConfig };
...
function resolveConfiguredModelRaw(cfg: TheiaOSConfig): string {
...
function resolveConfiguredModelKeys(cfg: TheiaOSConfig): string[] {
...
export function applyPrimaryModel(cfg: TheiaOSConfig, model: string): TheiaOSConfig {
...
export function applyModelAllowlist(cfg: TheiaOSConfig, models: string[]): TheiaOSConfig {
  const defaults = cfg.agents?.defaults;
