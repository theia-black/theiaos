...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.theiaos.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("theiaos hooks list")}`,
      `  ${formatCliCommand("theiaos hooks enable <name>")}`,
      `  ${formatCliCommand("theiaos hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
