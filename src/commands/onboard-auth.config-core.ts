...
export function applyOpenrouterProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: TheiaOSConfig): TheiaOSConfig {
...
export function applyMoonshotConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: TheiaOSConfig): TheiaOSConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: TheiaOSConfig): TheiaOSConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: TheiaOSConfig): TheiaOSConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: TheiaOSConfig): TheiaOSConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: TheiaOSConfig): TheiaOSConfig {
...
export function applyQianfanProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: TheiaOSConfig): TheiaOSConfig {
