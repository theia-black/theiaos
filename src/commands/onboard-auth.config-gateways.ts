...
export function applyVercelAiGatewayProviderConfig(cfg: TheiaOSConfig): TheiaOSConfig {
...
export function applyVercelAiGatewayConfig(cfg: TheiaOSConfig): TheiaOSConfig {
