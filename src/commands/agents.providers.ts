...
function resolveDefaultAccountId(cfg: TheiaOSConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: TheiaOSConfig): boolean {
...
export function summarizeBindings(cfg: TheiaOSConfig, bindings: AgentBinding[]): string[] {
