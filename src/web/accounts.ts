...
export function listWhatsAppAuthDirs(cfg: TheiaOSConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: TheiaOSConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: TheiaOSConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: TheiaOSConfig): ResolvedWhatsAppAccount[] {
