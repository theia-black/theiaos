...
function resolveGatewayPort(cfg: TheiaOSConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: TheiaOSConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.THEIAOS_GATEWAY_PASSWORD?.trim() ||
