      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["theiaos gateway run", "Run the gateway in the foreground."],
            ["theiaos gateway status", "Show service status and probe reachability."],
            ["theiaos gateway discover", "Find local and wide-area gateway beacons."],
            ["theiaos gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.theiaos.ai/cli/gateway")}\n`,
      ),
  );
