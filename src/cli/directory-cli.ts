    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["theiaos directory self --channel slack", "Show the connected account identity."],
          [
            'theiaos directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["theiaos directory groups list --channel discord", "List available groups/channels."],
          [
            "theiaos directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.theiaos.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
