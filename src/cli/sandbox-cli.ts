...
const SANDBOX_EXAMPLES = {
  main: [
    ["theiaos sandbox list", "List all sandbox containers."],
    ["theiaos sandbox list --browser", "List only browser containers."],
    ["theiaos sandbox recreate --all", "Recreate all containers."],
    ["theiaos sandbox recreate --session main", "Recreate a specific session."],
    ["theiaos sandbox recreate --agent mybot", "Recreate agent containers."],
    ["theiaos sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["theiaos sandbox list", "List all sandbox containers."],
    ["theiaos sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["theiaos sandbox recreate --all", "Recreate all containers."],
    ["theiaos sandbox recreate --session main", "Recreate a specific session."],
    ["theiaos sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["theiaos sandbox recreate --browser --all", "Recreate only browser containers."],
    ["theiaos sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["theiaos sandbox explain", "Show effective sandbox config."],
    ["theiaos sandbox explain --session agent:main:main", "Explain a specific session."],
    ["theiaos sandbox explain --agent work", "Explain an agent sandbox."],
    ["theiaos sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.theiaos.ai/cli/sandbox")}\n`,
    )
    .action(() => {
