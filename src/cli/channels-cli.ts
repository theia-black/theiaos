    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["theiaos channels list", "List configured channels and auth profiles."],
          ["theiaos channels status --probe", "Run channel status checks and probes."],
          [
            "theiaos channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["theiaos channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.theiaos.ai/cli/channels",
        )}\n`,
    );
