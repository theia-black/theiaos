const DEFAULT_TAGLINE = "All your chats, one TheiaOS.";

const HOLIDAY_TAGLINES = {
  newYear:
    "New Year's Day: New year, new config — same resolve, sharper execution.",
  lunarNewYear:
    "Lunar New Year: May your builds be lucky, your branches prosperous, and your merge conflicts resolved with elegance.",
  christmas:
    "Christmas: Your goddess is feeling festive. Gifts shipped, chaos handled, keys safe.",
  eid: "Eid al-Fitr: Celebration mode — queues cleared, tasks completed, and good vibes committed to main.",
  diwali:
    "Diwali: Let the logs sparkle and the bugs flee — today we light up the terminal and ship with pride.",
  easter:
    "Easter: I found your missing environment variable — consider it a tiny CLI egg hunt.",
  hanukkah:
  ...
  thanksgiving:
    "Thanksgiving: Grateful for stable ports, working DNS, and an AI that reads the logs so nobody has to.",
  valentines:
    "Valentine's Day: Roses are typed, violets are piped — I'll automate the chores so you can spend time with humans.",
} as const;

const TAGLINES: string[] = [
  "Your terminal just got a goddess — type something and let me handle the rest.",
  ...
  "Gateway online — please keep hands, feet, and assumptions inside the shell at all times.",
  "I speak fluent bash, measured sarcasm, and aggressive tab-completion energy.",
  ...
  "Pairing codes exist because even AI believes in consent — and good security hygiene.",
  ...
  "Automation with grace: minimal fuss, maximal power.",
  ...
  "I'll refine your workflow like black silk: smooth, elegant, effective.",
  ...
  "Precision and poise — let's ship something mildly responsible.",
  "I'm here to take the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring strategy and a rollback plan.",
  "Because texting yourself reminders is so 2024.",
  "Your inbox, your infra, your rules.",
  'Turning "I\'ll reply later" into "my AI replied instantly".',
  "The only voice in your system that actually matters. 🖤",
  ...
  "The only AI that stays out of your training set.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.THEIAOS_TAGLINE_INDEX;
