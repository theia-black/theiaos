...
// Prefix for TheiaOS-generated action IDs to scope our handler
const THEIAOS_ACTION_PREFIX = "theiaos:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle TheiaOS modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${THEIAOS_ACTION_PREFIX}`),
