...
function mergeSlackAccountConfig(cfg: TheiaOSConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: TheiaOSConfig): ResolvedSlackAccount[] {
