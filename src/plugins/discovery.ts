...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @theiaos/voice-call -> voice-call).
...
export function discoverTheiaOSPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".theiaos", "extensions")];
