...
const loadTheiaOSPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadTheiaOSPlugins: (params: unknown) => loadTheiaOSPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadTheiaOSPluginsMock.mockReturnValue(registry);
  return registry;
}

describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadTheiaOSPluginsMock.mockReset();
  });
