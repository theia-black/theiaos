...
export function listBindings(cfg: TheiaOSConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: TheiaOSConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: TheiaOSConfig) {
