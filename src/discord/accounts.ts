...
function mergeDiscordAccountConfig(cfg: TheiaOSConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: TheiaOSConfig): ResolvedDiscordAccount[] {
