...
const resolveStorePath = vi.fn(() => "/tmp/theiaos-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/theiaos-discord-process-test-sessions.json");
});
