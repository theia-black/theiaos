...
describe("agent components", () => {
  const createCfg = (): TheiaOSConfig => ({}) as TheiaOSConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockReset().mockReturnValue("/tmp/theiaos-sessions-test.json");
  });
