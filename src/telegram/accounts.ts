...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.THEIAOS_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: TheiaOSConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: TheiaOSConfig): string {
...
function mergeTelegramAccountConfig(cfg: TheiaOSConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: TheiaOSConfig): ResolvedTelegramAccount[] {
