...
beforeAll(async () => {
  previousToken = process.env.THEIAOS_GATEWAY_TOKEN;
  process.env.THEIAOS_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "theiaos-ios", platform: "ios" },
  { clientId: "theiaos-android", platform: "android" },
