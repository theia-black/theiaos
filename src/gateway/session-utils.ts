...
import { type TheiaOSConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: TheiaOSConfig): string[] {
...
export function listAgentsForGateway(cfg: TheiaOSConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: TheiaOSConfig): string {
...
function resolveSessionStoreAgentId(cfg: TheiaOSConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: TheiaOSConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: TheiaOSConfig): GatewaySessionsDefaults {
