...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.THEIAOS_TTS_PREFS;
      process.env.THEIAOS_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.THEIAOS_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: TheiaOSConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
