...
export function resolveTtsConfig(cfg: TheiaOSConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.THEIAOS_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: TheiaOSConfig): string | undefined {
