...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/theia-black/theiaos/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.THEIAOS_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.theiaos/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: TheiaOSConfig = {
    ...params.cfg,
