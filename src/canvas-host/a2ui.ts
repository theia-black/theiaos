...
export const A2UI_PATH = "/__theiaos__/a2ui";

export const CANVAS_HOST_PATH = "/__theiaos__/canvas";

export const CANVAS_WS_PATH = "/__theiaos__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.theiaosCanvasA2UIAction.postMessage(...)
  // - Android: window.theiaosCanvasA2UIAction.postMessage(...)
  const handlerNames = ["theiaosCanvasA2UIAction"];
  ...
  globalThis.TheiaOS = globalThis.TheiaOS ?? {};
  globalThis.TheiaOS.postMessage = postToNode;
  globalThis.TheiaOS.sendUserAction = sendUserAction;
  globalThis.theiaosPostMessage = postToNode;
  globalThis.theiaosSendUserAction = sendUserAction;
