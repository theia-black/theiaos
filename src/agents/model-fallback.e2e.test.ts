...
function makeCfg(overrides: Partial<TheiaOSConfig> = {}): TheiaOSConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): TheiaOSConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): TheiaOSConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
