...
import { resolveTheiaOSDocsPath } from "../../docs-path.js";
...
import { createTheiaOSCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
  ...
  try {
    ...
    const promptMode =
      isSubagentSessionKey(params.sessionKey) || isCronSessionKey(params.sessionKey)
        ? "minimal"
        : "full";
    const docsPath = await resolveTheiaOSDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/theia-black/theiaos/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt") {
          try {
            sessionManager.appendCustomEntry("theiaos:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/theia-black/theiaos/issues/8643
