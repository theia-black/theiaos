...
const CLEANUP_STATE_KEY = Symbol.for("theiaos.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("theiaos.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("theiaos.sessionWriteLockWatchdogState");
