...
function resolveAdaptiveReadMaxBytes(options?: TheiaOSReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createTheiaOSReadTool(base, {
...
export function createTheiaOSReadTool(
  base: AnyAgentTool,
  options?: TheiaOSReadToolOptions,
): AnyAgentTool {
