...
function resolveWatchPaths(workspaceDir: string, config?: TheiaOSConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: TheiaOSConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: TheiaOSConfig }) {
