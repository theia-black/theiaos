...
export const DEFAULT_SANDBOX_IMAGE = "theiaos-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "theiaos-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "theiaos-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "theiaos-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "theiaos-sbx-browser-";
