...
function resolveAvatarSource(cfg: TheiaOSConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: TheiaOSConfig, agentId: string): AgentAvatarResolution {
