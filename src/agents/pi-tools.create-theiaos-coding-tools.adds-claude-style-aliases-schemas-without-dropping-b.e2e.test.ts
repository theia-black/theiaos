...
describe("createTheiaOSCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createTheiaOSCodingTools({
      config,
    ...
    const anthropicTools = createTheiaOSCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createTheiaOSCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createTheiaOSCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
