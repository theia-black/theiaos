...
function isTelegramConfigured(cfg: TheiaOSConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: TheiaOSConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: TheiaOSConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: TheiaOSConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: TheiaOSConfig): boolean {
...
function isIMessageConfigured(cfg: TheiaOSConfig): boolean {
...
function isWhatsAppConfigured(cfg: TheiaOSConfig): boolean {
...
function isGenericChannelConfigured(cfg: TheiaOSConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: TheiaOSConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: TheiaOSConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: TheiaOSConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: TheiaOSConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: TheiaOSConfig, pluginId: string): TheiaOSConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
