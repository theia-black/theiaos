...
function resolveAnthropicDefaultAuthMode(cfg: TheiaOSConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: TheiaOSConfig): TheiaOSConfig {
...
export function applyTalkApiKey(config: TheiaOSConfig): TheiaOSConfig {
...
export function applyModelDefaults(cfg: TheiaOSConfig): TheiaOSConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: TheiaOSConfig): TheiaOSConfig {
...
export function applyLoggingDefaults(cfg: TheiaOSConfig): TheiaOSConfig {
...
export function applyContextPruningDefaults(cfg: TheiaOSConfig): TheiaOSConfig {
...
export function applyCompactionDefaults(cfg: TheiaOSConfig): TheiaOSConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
