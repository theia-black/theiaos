...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof TheiaOSConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: TheiaOSConfig; env: NodeJS.ProcessEnv }): {
  cfg: TheiaOSConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
