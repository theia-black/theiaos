...
function mergeIMessageAccountConfig(cfg: TheiaOSConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: TheiaOSConfig): ResolvedIMessageAccount[] {
