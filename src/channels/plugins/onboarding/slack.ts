...
function setSlackDmPolicy(cfg: TheiaOSConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "TheiaOS";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for TheiaOS`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: TheiaOSConfig, allowFrom: string[]): TheiaOSConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
