...
export type ChannelAgentToolFactory = (params: { cfg?: TheiaOSConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: TheiaOSConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: TheiaOSConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: TheiaOSConfig }) => boolean;
  supportsCards?: (params: { cfg: TheiaOSConfig }) => boolean;
