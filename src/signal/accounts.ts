...
function mergeSignalAccountConfig(cfg: TheiaOSConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: TheiaOSConfig): ResolvedSignalAccount[] {
