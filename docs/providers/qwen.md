---
summary: "Use Qwen OAuth (free tier) in TheiaOS"
read_when:
  - You want to use Qwen with TheiaOS
...
If you already logged in with the Qwen Code CLI, TheiaOS will sync credentials
