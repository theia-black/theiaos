---
summary: "Use NVIDIA's OpenAI-compatible API in TheiaOS"
read_when:
  - You want to use NVIDIA models in TheiaOS
...
theiaos onboard --auth-choice skip
theiaos models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
