...
Deepgram is a speech-to-text API. In TheiaOS it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, TheiaOS uploads the audio file to Deepgram and injects the transcript
