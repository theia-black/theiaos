---
summary: "Use Synthetic's Anthropic-compatible API in TheiaOS"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. TheiaOS registers it as the
...
Note: TheiaOS's Anthropic client appends `/v1` to the base URL, so use
