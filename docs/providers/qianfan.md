---
summary: "Use Qianfan's unified API to access many models in TheiaOS"
read_when:
...
3. TheiaOS installed on your system
...
4. Copy the API key for use with TheiaOS

## CLI setup

```bash
theiaos onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [TheiaOS Configuration](/gateway/configuration)
