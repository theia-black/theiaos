---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with TheiaOS"
read_when:
  - You want Xiaomi MiMo models in TheiaOS
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). TheiaOS uses
