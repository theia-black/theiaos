...
You can point TheiaOS at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or TheiaOS
...
- [Anthropic provider](/providers/anthropic) - Native TheiaOS integration with Claude setup-token or API keys
