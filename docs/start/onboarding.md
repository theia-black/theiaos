---
summary: "First-run onboarding flow for TheiaOS (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give TheiaOS">
...
<Step title="CLI">
  ...
  The app can install the global `theiaos` CLI via npm/pnpm so terminal
