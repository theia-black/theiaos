---
summary: "Overview of TheiaOS onboarding options and flows"
read_when:
...
TheiaOS supports multiple onboarding paths depending on where the Gateway runs
...
- [`theiaos onboard` command](/cli/onboard)

## macOS app onboarding

Use the TheiaOS app when you want a fully guided setup on macOS. Docs:
