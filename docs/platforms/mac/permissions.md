...
- Same path: run the app from a fixed location (for TheiaOS, `dist/TheiaOS.app`).
...
Workaround: move files into the TheiaOS workspace (`~/.theiaos/workspace`) if you want to avoid per-folder grants.
