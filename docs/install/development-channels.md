...
TheiaOS ships three update channels:
...
When you **explicitly** switch channels with `--channel`, TheiaOS also aligns
the install method:
...
When you switch channels with `theiaos update`, TheiaOS also syncs plugin sources:
