...
TheiaOS treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.theiaos/settings/voicewake.json`

Shape:

```json
{ "triggers": ["theiaos", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
