...
本指南总结了在 TheiaOS 中开发 Pi 集成的合理工作流程。
...
状态存储在 TheiaOS 状态目录下。默认为 `~/.theiaos`。如果设置了 `THEIAOS_STATE_DIR`，则使用该目录。
...
- https://docs.theiaos.ai/testing
- https://docs.theiaos.ai/start/getting-started
