...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure TheiaOS HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `theiaos pairing approve slack <code>`.
...
TheiaOS supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, TheiaOS falls back to normal delivery for remaining payloads.
