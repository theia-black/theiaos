...
- Install via CLI: `theiaos plugins install @theiaos/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `theiaos plugins install ./extensions/zalo`
   - From npm (if published): `theiaos plugins install @theiaos/zalo`
...
- Approve via:
  - `theiaos pairing list zalo`
  - `theiaos pairing approve zalo <CODE>`
...
- Example: `theiaos message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `theiaos channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `theiaos logs --follow`
