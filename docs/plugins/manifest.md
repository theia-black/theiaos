...
read_when:
  - You are building a TheiaOS plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (theiaos.plugin.json)

Every plugin **must** ship a `theiaos.plugin.json` file in the **plugin root**.
TheiaOS uses this manifest to validate configuration **without executing plugin
