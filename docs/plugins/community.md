...
read_when:
  - You want to publish a third-party TheiaOS plugin
...
This page tracks high-quality **community-maintained plugins** for TheiaOS.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `theiaos plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `theiaos plugins install @scope/package`
