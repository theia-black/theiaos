...
This guide summarizes a sane workflow for working on the pi integration in TheiaOS.
...
- Trigger the agent directly:
  - `pnpm theiaos agent --message "Hello" --thinking low`
...
State lives under the TheiaOS state directory. Default is `~/.theiaos`. If `THEIAOS_STATE_DIR` is set, use that directory instead.

To reset everything:

- `theiaos.json` for config
...
- [https://docs.theiaos.ai/testing](https://docs.theiaos.ai/testing)
- [https://docs.theiaos.ai/start/getting-started](https://docs.theiaos.ai/start/getting-started)
