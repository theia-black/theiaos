...
if [[ -z "$version_content" ]]; then
  echo "<h2>TheiaOS $VERSION</h2>"
  echo "<p>Latest TheiaOS update.</p>"
  echo "<p><a href=\"https://github.com/theia-black/theiaos/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
