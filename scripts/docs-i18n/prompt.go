...
- Keep product names in English: TheiaOS, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the TheiaOS Gateway, use “Gateway 网关”.
