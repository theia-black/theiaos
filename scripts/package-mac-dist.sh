...
# Output:
# - dist/TheiaOS.app
# - dist/TheiaOS-<version>.zip
# - dist/TheiaOS-<version>.dmg
...
ZIP="$ROOT_DIR/dist/TheiaOS-$VERSION.zip"
DMG="$ROOT_DIR/dist/TheiaOS-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/TheiaOS-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/TheiaOS-$VERSION.dSYM.zip"
