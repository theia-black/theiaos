...
export function listMattermostAccountIds(cfg: TheiaOSConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: TheiaOSConfig): string {
...
export function listEnabledMattermostAccounts(cfg: TheiaOSConfig): ResolvedMattermostAccount[] {
