import type { ChannelOnboardingAdapter, TheiaOSConfig, WizardPrompter } from "theiaos/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.theiaos.ai/channels/mattermost",
    ].join("\n"),
