...
export function listZalouserAccountIds(cfg: TheiaOSConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: TheiaOSConfig): string {
...
function mergeZalouserAccountConfig(cfg: TheiaOSConfig, accountId: string): ZalouserAccountConfig {
