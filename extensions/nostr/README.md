...
Nostr DM channel plugin for TheiaOS using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to TheiaOS. It enables your bot to:
...
# Configure theiaos to use local relay
