...
- Version alignment with core TheiaOS release numbers.
...
- First public release of the @theiaos/voice-call plugin.
...
- CLI: `theiaos voicecall` commands (call/start/continue/speak/end/status/tail/expose).
