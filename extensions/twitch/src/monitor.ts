...
import type { ReplyPayload, TheiaOSConfig } from "theiaos/plugin-sdk";
import { createReplyPrefixOptions } from "theiaos/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as TheiaOSConfig;
