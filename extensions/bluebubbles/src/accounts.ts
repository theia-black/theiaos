...
export function listBlueBubblesAccountIds(cfg: TheiaOSConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: TheiaOSConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: TheiaOSConfig): ResolvedBlueBubblesAccount[] {
