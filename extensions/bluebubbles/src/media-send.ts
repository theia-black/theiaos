...
import { resolveChannelMediaMaxBytes, type TheiaOSConfig } from "theiaos/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: TheiaOSConfig; accountId?: string }): string[] {
