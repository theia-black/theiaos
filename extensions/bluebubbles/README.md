...
This directory contains the **BlueBubbles external channel plugin** for TheiaOS.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `theiaos/plugin-sdk` helpers.
